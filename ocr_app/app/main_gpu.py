...
from app.image_preprocessings import preprocess_for_ocr
from app.roi_detection_model import detect_objects  # your detection model
from app.ocr_paddle_gpu import PaddleOcrWrapper  # Import OCR wrapper class
